...
@include("admin.layouts.components.submit_form_ajax",["form"=>"#clients"])
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        {!! Form::label('text',trans('admin.text'),['class'=>'control-label']) !!}
        {!! Form::textarea('text', $clients->text ,['class'=>'form-control','placeholder'=>trans('admin.text')]) !!}
    </div>
</div>
