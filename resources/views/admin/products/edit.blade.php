...
@include("admin.layouts.components.submit_form_ajax",["form"=>"#products"])
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('name', $products->name ,['class'=>'form-control','placeholder'=>trans('admin.name')]) !!}
    </div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 photo">
    <div class="row">
        ...
        <div class="col-md-2" style="padding-top: 30px;">
            @include("admin.show_image",["image"=>$products->photo])
        </div>
    </div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::textarea('description', $products->description ,['class'=>'form-control ckeditor','placeholder'=>trans('admin.description')]) !!}
    </div>
</div>
