...
@include("admin.layouts.components.submit_form_ajax",["form"=>"#sliders"])
	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{aurl('sliders')}}" class="dropdown-item" style="color:#343a40">
				<i class="fas fa-list"></i> {{trans('admin.show_all')}} </a>
				<a href="{{aurl('sliders/'.$sliders->id)}}" class="dropdown-item" style="color:#343a40">
				<i class="fa fa-eye"></i> {{trans('admin.show')}} </a>
				<a class="dropdown-item" style="color:#343a40" href="{{aurl('sliders/create')}}">
					<i class="fa fa-plus"></i> {{trans('admin.create')}}
				</a>
				<div class="dropdown-divider"></div>
				<a data-toggle="modal" data-target="#deleteRecord{{$sliders->id}}" class="dropdown-item" style="color:#343a40" href="#">
		...
		@push('js')
		<div class="modal fade" id="deleteRecord{{$sliders->id}}">
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('title', $sliders->title ,['class'=>'form-control','placeholder'=>trans('admin.title')]) !!}
    </div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 photo">
    <div class="row">
        ...
        <div class="col-md-2" style="padding-top: 30px;">
            @include("admin.show_image",["image"=>$sliders->photo])
        </div>
    </div>
</div>
