...
@include("admin.layouts.components.submit_form_ajax",["form"=>"#statistics"])
	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('statistics') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/statistics'),'id'=>'statistics','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
